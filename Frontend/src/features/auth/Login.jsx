...
export const Login = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    setLoading(true);
    try {
      const msg = await authService.resetPassword(email, resetToken, newPassword);
      showToast(msg, 'success');
      setView('login');
      setPassword('');
      setNewPassword('');
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-6 font-sans overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#714B67]/40 rounded-full blur-3xl pointer-events-none animate-pulse z-0" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#AA3BFF]/30 rounded-full blur-3xl pointer-events-none z-0" />
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span 
                      ...
                      className="text-xs text-[#714B67] dark:text-purple-400 hover:underline cursor-pointer"
                    >
                      Forgot password?
                    </span>
                  </div>
          ...
          {view === 'forgot' && (
            <>
              <div className="mb-6">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  Enter your corporate email and we'll send you a 6-digit verification code.
                </p>
              </div>
              ...
              <form onSubmit={handleForgotPassword} className="space-y-4">
                ...
                <div className="mt-4 text-center">
                  <span 
                    ...
                    className="text-xs font-semibold text-[#714B67] dark:text-purple-400 hover:underline cursor-pointer"
                  >
                    Back to Sign In
                  </span>
                </div>
